...
ueber den geteilten additiven Mixer (`drachenhauch.audio_preview.Mixer`, auch
vom Tracker genutzt), eigenes `*.json`-Format ODER Export/Uebernahme in den
Tracker (`drachenhauch.score.convert.to_tracker_song`).

Das Datenmodell + die Tracker-Konvertierung liegen Qt-frei in
`drachenhauch.score` (headless getestet).
...
class ScoreEditor(QMainWindow):
    ...
    def _build_toolbar(self) -> QHBoxLayout:
        ...
        b_tracker.setToolTip(
            ...
            "Spur + Instrument) und oeffnet es in dhtracker")
    ...
    def _export_to_tracker(self) -> None:
        ...
        try:
            ...
            QMessageBox.information(
                ...
                "Oeffne es manuell mit dhtracker.")
