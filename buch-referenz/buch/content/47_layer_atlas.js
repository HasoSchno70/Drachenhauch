module.exports = (H) => [
  ...
  H.cmd("ATLAS_DRAW_FLIPPED", 'ATLAS_DRAW_FLIPPED(atlas, name$, x, y[, flipX[, flipY]])',
    "Zeichnet ein Sub-Sprite gespiegelt. Klassisch für Lauf-Animationen: Nur die nach rechts blickende Variante liegt im Atlas, nach links wird per flipX abgeleitet. Die Flip-Schalter gibst du als 1 (spiegeln) oder 0 (nicht) an.",
    [
      'DIM linksFlag AS INTEGER',
      'linksFlag = 1                  \' 1 = nach links spiegeln, 0 = nicht',
      'ATLAS_DRAW_FLIPPED(atlas, "walk_a", x, y, linksFlag, 0)',
    ]),
