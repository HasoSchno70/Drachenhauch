...
(Verschieben) → 0,25 (.gpl-Paletten). Der Faktor wurde mit jedem nachgeholten
Stück **schlechter**, ohne dass eine Zeile schlechter geworden wäre.
