module.exports = (H) => [
  ...
  H.p("GameBasic besteht aus zwei Teilen: der Laufzeit „dhrt“, die deine Programme ausführt, und einer Sammlung von Editoren, mit denen du Code, Grafik, Musik und mehr erstellst. Auf einem eingerichteten System liegt alles bereit; du startest die Werkzeuge über kurze Befehle in der Eingabeaufforderung."),
  ...
  H.bulletRich("Speichern: ", "Strg+S. GameBasic-Programme haben die Endung .dh."),
  ...
  H.code(['dhrun.py mein_programm.dh']),
