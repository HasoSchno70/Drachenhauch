module.exports = (H) => [
  ...
  H.p("In Drachenhauch meldest du jede Variable zuerst an. Das macht der Befehl DIM (von englisch „dimension“, „Maß festlegen“). Du sagst dabei zwei Dinge: wie die Variable heißt und welchen Typ sie hat – also welche Art Wert hineinpasst."),
  H.code([
  ...
  H.note("Anlegen (DIM) und Belegen (=) darfst du auch trennen oder zusammenziehen. Anlegen musst du eine Variable aber, bevor du sie benutzt – das schützt dich vor Tippfehlern: Schreibst du später versehentlich „punke“, merkt Drachenhauch, dass es diese Schublade gar nicht gibt."),

  H.h2("Die vier Grundtypen"),
  H.p("Drachenhauch kennt vier grundlegende Werttypen. Jede Variable hat genau einen davon – das ist die „Pascal-strenge Typisierung“, von der manchmal die Rede ist. Sie klingt streng, ist aber dein Freund: Sie fängt eine ganze Klasse von Fehlern ab, bevor sie passieren."),
  ...
  H.p("Weil jede Variable ihren Typ hat, kann Drachenhauch Unsinn früh erkennen. Eine ganze Zahl in eine FLOAT-Schublade zu legen ist in Ordnung (aus 3 wird 3.0). Aber Text in eine Zahl-Schublade zu zwingen geht nicht – und das ist gut so, denn es wäre fast immer ein Versehen."),
