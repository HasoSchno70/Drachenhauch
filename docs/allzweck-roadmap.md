...
- [x] **`TASK_START` (2026-08-19)** — gebaut über den dritten Weg aus
      [entwurf-task-start.md](entwurf-task-start.md): der Auftrag läuft als
      eigener `dhrt`-Prozess statt als Thread. Damit verschwindet das
