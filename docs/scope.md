...
Implementierungs-Referenz: Scope-Auflösung in `dhrt` — [compiler.rs](../rust/drachenhauch_runtime/src/compiler.rs) (Slot-Allokation) + [vm.rs](../rust/drachenhauch_runtime/src/vm.rs) (Locals/Globals).
