...
class Song:
    ...
    def dh_code(self) -> str:
        ...
        lines = [
            'IMPORT "audio"', "",
            f"' === Tracker-Song (dhtracker) -- {n_patterns} Pattern(s), "
