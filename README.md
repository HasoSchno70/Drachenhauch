...
- **[Module](docs/README.md#module)** — `json`, `db`, `tween`, `imgfx`, `particles`, `physics`, **[`physics2d`](docs/module-physics2d.md)** (echte 2D-Starrkörper-Physik via Rapier2D: Schwerkraft/Kollision/Restitution/Rotation, `PHYS2D_*`, [examples/112_physics2d.gb](examples/112_physics2d.gb)), **`physics3d`** (echte 3D-Starrkörper-Physik via Rapier3D: Schwerkraft/Kollision/Restitution, `PHYS3D_*`, [examples/107_physics3d.gb](examples/107_physics3d.gb)), `camera`, `sprite`, **[`animfsm`](docs/module-animfsm.md)** (Animations-State-Machine, Unity-Mecanim-Stil: States + Parameter + Transitions aus `.gbanim`, Editor `gbanim`), `ui`, `scene`, `save`, `astar`, `ecs`, `vec2`, [`m3d`](docs/module-m3d.md) (3D-Mathe: VEC3/VEC4/QUAT/MAT4 + `MODEL_MATRIX`), `input`, `regex`, `audio`, `curves`, `net`, **[`timer`](docs/module-timer.md)** (geplante Aktionen: `TIMER_AFTER/EVERY` mit FUNCREF-Callbacks + `COOLDOWN`-Ratenbegrenzer, [examples/113_timer.gb](examples/113_timer.gb))
