"""Tests fuer die CIRCUIT RUNNER Level-Werkzeuge (DAT-Konverter + Demo-Bauer).
...
(ASCII -> JSON). Reine Python-Pipeline, kein dhrt noetig -- solange die
Werkzeuge selbst Python sind, bleiben ihre Tests hier.

Das Verhalten der ENGINE (Monster-Reihenfolge und -Tempo, Bestzeiten,
Passwoerter, Hinweissteine) pruefen seit Stufe 53 (2026-09-14) die Faelle in
`tests/pruef/werkzeug_circuitrunner.dhtest`.
"""
