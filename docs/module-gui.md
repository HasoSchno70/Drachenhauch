...
Das Mausrad rollt Listen, Tabellen, Bäume, Textbereiche, gesetzten Text,
rollende Panels und scrollbare Fenster -- aber **nicht mit gedrückter
Strg-Taste**: Strg+Rad heißt in jedem Editor „Zoom“, und rollte dabei auch
noch der Inhalt unter der Maus, spränge er bei jedem Schritt weg. Das Programm
fragt dann selbst: `IF KEYPRESSED(KEY_LCTRL) AND MOUSEWHEEL_Y() <> 0 THEN ...`.
Ein **Textbereich** rollt seit 2026-09-18 drei Zeilen je Schritt (vorher gar
