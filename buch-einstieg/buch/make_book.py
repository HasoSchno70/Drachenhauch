#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Zwei-Pass-Build von "Drachenhauch - Der Einstieg" mit korrekten ToC-Seitenzahlen.
...
# Nur deutsch: dieses Buch hat (noch) keine Uebersetzungsschicht.
_BASIS = {"de": "Drachenhauch-Einstieg"}
...
if LANG not in _BASIS:
    raise SystemExit(f"Unbekannte Sprache: {LANG} (nur de)")
