...
[examples/72_net_chat.dh](../examples/72_net_chat.dh) zeigt einen kleinen Chat (TCP-Server + Client). UDP-Beispiele sind in den Tests (`tests/pruef/modules_net.dhtest`) zu finden.
