module.exports = (H) => [
  ...
  H.bulletRich("3D-Modelle:  ", "LOADMODEL lädt fertige Modelle (OBJ/GLTF), MESH_CUBE/SPHERE/TORUS u. a. erzeugen welche prozedural; gezeichnet mit MODEL. Sogar Skelett-Animationen sind möglich – MODEL_ANIMATE setzt eine Pose, MODEL_ANIMATE_BLEND blendet weich zwischen zwei Animationen (z. B. Gehen → Rennen) statt hart umzuschalten."),
  ...
  H.bulletRich("Kamera-Modi, Orbit & Picking:  ", "CAMERA3D_UPDATE bietet fertige Steuerungen (frei, orbital, Ego-Perspektive); CAMERA_ORBIT positioniert die Kamera direkt über Kugelkoordinaten (Ziel, Abstand, Yaw/Pitch) – erspart die Trigonometrie fürs Umkreisen eines Objekts. Mit PICK_BOX/PICK_SPHERE/PICK_MODEL wählst du Objekte bzw. geladene Modelle per Mausklick aus (RAY_HIT_MODEL liefert dieselbe Trefferprüfung mit einem selbst gewählten Strahl statt der Maus). WORLD_TO_SCREEN_X/Y rechnen umgekehrt eine 3D-Position auf ihre Bildschirm-Pixel um (z. B. für ein Namensschild über einem Charakter), SCREEN_TO_WORLD_DIR_X/Y/Z liefern die Blickrichtung durch einen Bildschirm-Pixel als 3D-Vektor (Grundlage für eigenes Raycasting)."),
