...
| Tracker (190) | dasselbe JSON; Sample-, Keymap- und SoundFont-Instrumente werden **gespielt** (seit 2026-09-21, `SAMPLE_FROM_BUFFER`/`SAMPLE_NOTE`) und beim Sichern unverändert zurückgeschrieben -- bis 2026-09-17 schrieb der Pilot sie als `synth` und die Samples waren weg | Samples laden und bearbeiten (WAV/OGG/SF2, Keymap-Dialog, Loop-Marker); VU-Meter; Patterns benennen; der Sample-Offset-Effekt |
