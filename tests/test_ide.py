...
`tests/pruef/werkzeug_ide_6_12.dhtest` (beide ohne Python). Hier geblieben
sind aus diesen Staenden nur die, die zwei IDE-Laeufe hintereinander brauchen
(Sitzung, Umbruch, die Lage des Farbfelds), ein git-Repository, einen fremden
PDF-Leser oder im Bild Farbbaender zaehlen.
